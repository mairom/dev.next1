...
<script src="<?php echo base_url('assets/js/Ciuis.js?v=1.3.5'); ?>" type="text/javascript"></script>
...
<script src="<?php echo base_url('assets/js/CiuisAngular.js?v=1.3.5'); ?>"></script>
...
<script type="text/javascript">
	...
	<?php if (session()->getFlashdata('login_notification')) {
		...
		var staffname = "<?php echo $message = sprintf(lang('welcome_once_message'), session()->get('staffname')) ?> ";
