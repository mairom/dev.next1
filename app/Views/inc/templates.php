<script type="text/ng-template" id="ciuis-sidebar.html">
    ...
    margin: 0;
    margin-top: 5px;
    margin-bottom: -10px;">Atividades à fazer</h3>
			<div class="events events_xs col-md-12">
				<ul>
					...
					<li ng-repeat="invoice in dueinvoices track by (invoice.id || $index)" class="next dueinvoices">
						<label class="date"> <i class="ion-alert"></i> </label>
					...
					<li ng-repeat="newticket in newtickets track by (newticket.id || $index)" class="next newticketsidebar">
					...
					<label class="detail"><i class="ion-ios-bell"></i></label>
						<a ng-click='ReminderRead(reminder.id)' style="cursor: pointer">
							...
							<md-tooltip md-direction="top"> <?php echo lang2('mark_as') . ' ' . lang2('read') ?></md-tooltip>
						</a>
...
<script type="text/ng-template" id="custom-fields.html">
	...
	<md-subheader ng-if="custom_fields != false" class="md-primary"><?php echo lang2('custom_fields') ?></md-subheader>
