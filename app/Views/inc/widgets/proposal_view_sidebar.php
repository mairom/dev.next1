      ...
      <div class="panel-heading">
        <div id="details" class="clearfix" style="font-size: 12px;">
          <div id="proposal">
            ...
            <div class="date text-bold"><?php echo lang2('dateofissuance')?>:
              <?php echo date(get_dateFormat(), strtotime($proposals['date']))?>
            </div>
            <div class="date text-bold"><?php echo lang2('opentill')?>:
        ...
        <?php }?>
        <div style="<?php if($proposals['comment']!=1){echo 'display:none;';}?>"> <?php helper('form'); echo form_open_multipart('share/customercomment',array("class"=>"")); ?>
