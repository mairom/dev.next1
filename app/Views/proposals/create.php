  ...
  <div  class="main-content container-fluid col-xs-12 col-md-12 col-lg-9">
    ...
    <md-toolbar class="toolbar-white">
      ...
      <div class="md-toolbar-tools">
        ...
        <h2 flex md-truncate><?php echo lang2('createproposal') ?></h2>

        <md-switch ng-model="proposal_type" aria-label="Type" ng-cloak><strong class="text-muted"><?php echo lang2('for_lead')?></strong></md-switch>
        ...
        <md-button type="button" ng-click="saveAll()" class="md-icon-button" aria-label="Save" ng-cloak>
          ...
          <md-tooltip ng-hide="savingProposal == true" md-direction="bottom"><?php echo lang2('create') ?></md-tooltip>
