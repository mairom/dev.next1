...
<div class="col-lg-4 col-lg-offset-4">
	<div class="col-lg-7 text-center col-lg-offset-3 bg-white" style="padding: 20px; border-radius: 5px; margin-top: 5%;" >
		...
		<h3><?php echo lang2('two_factor_authentication')?></h3>
		<small><?php echo lang2('two_factor_authentication_description_verify')?></small>
		<div class="input-group md-mt-5">
			<input type="text" name="code" placeholder="<?php echo lang2('type_your_verification_code') ?>" class="form-control"><span class="input-group-btn">
            <button  type="submit" class="btn btn-success"><?php echo lang2('verify')?></button></span>
		</div>
