	...
	<md-content class="main-content container-fluid col-md-12">
		<md-content class="bg-white" style="height:630px;">
			...
			<div class="space" ng-cloak>
				<md-button class="md-raised md-primary" ng-click="showDay()"><?php echo lang2('day') ?></md-button>
				<md-button class="md-raised md-primary" ng-click="showWeek()"><?php echo lang2('week') ?></md-button>
			</div>
			...
			<md-toolbar class="toolbar-white">
				<div class="md-toolbar-tools">
					<h2 flex md-truncate ><strong><?php echo lang2('appointments') ?></strong></h2>
				</div>
			</md-toolbar>
			<md-content class="appointments appointments_xs calendar-appointments" style="margin-top: 0px">
				<md-subheader class="md-no-sticky event-subheader"><i class="mdi mdi-calendar-alt"></i> <?php echo lang2('requested_appointments') ?></md-subheader>
			...
			<md-content class="appointments appointments_xs calendar-appointments" style="margin-top: 0px">
				<md-subheader class="md-no-sticky event-subheader"><i class="mdi mdi-calendar-alt"></i> <?php echo lang2('today_appointments') ?></md-subheader>
				<ul style="padding: 0px 20px 0px 20px;" ng-cloak>
       ...
       <md-content class="bg-white">
      	...
      	<h3 class="md-mt-0" ng-bind="appointment.start_iso_date | date : 'MMM d, y h:mm:ss a'"></h3>
			...
			<md-list-item>
				...
				<p ng-if="appointment.status == '3'"><strong class="text-success"><?php echo lang2('done') ?></strong></p>
			</md-list-item>
		</md-list>
      </md-content>     
    </md-dialog-content>
