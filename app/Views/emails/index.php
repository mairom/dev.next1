...
<div class="ciuis-body-content bg-white" ng-controller="Emails_Controller">
  <div class="main-content container-fluid col-xs-12 col-md-4 col-lg-4 bg-white">
    <div class="panel-heading" flex style="border-bottom: 1px solid gainsboro;"> <strong><?php echo lang2('emails'); ?></strong>
      <span class="panel-subtitle"><?php echo lang2('email_activities'); ?> ({{emails.length}})</span>
    </div>
    <!-- <div ng-show="template.loadEmails" layout-align="center center" class="text-center" id="circular_loader">
      ...
      <p style="font-size: 15px;margin-bottom: 5%;">
        <span>
          ...
          <small><strong><?php echo lang2('loading') . ' ' . lang2('emails') . '...' ?></strong></small>
        </span>
      </p>
    </div> -->
    <div ng-show="!template.loadEmails" class="row" style="padding: 0px 20px 0px 20px;">
      ...
      <md-content ng-show="!emails.length" class="md-padding bg-white no-item-data" ng-cloak><?php echo lang2('noemails') ?></md-content>
    </div>
  </div>
  <div class="main-content container-fluid col-xs-12 col-md-8 col-lg-8 md-p-0 bg-white" style="border-left: 1px solid gainsboro;">
    <md-toolbar class="toolbar-trans" style="border-bottom: 1px solid gainsboro;">
      <div class="md-toolbar-tools">
        <h2 flex md-truncate class="text-bold"><?php echo lang2('email_templates'); ?><br>
          <small flex md-truncate><?php echo lang2('manage_email_templates'); ?></small>
        </h2>

        <a href="<?php echo base_url('emails/templateAss/') ?>" class="md-icon-button" aria-label="New" ng-cloak>
          <md-tooltip md-direction="bottom">Assinatura dos emails</md-tooltip>
          <md-icon><i class="fas fa-file-signature text-success"></i></md-icon>
        </a>

        <a href="<?php echo base_url('emails/createEmail/') ?>" class="md-icon-button" aria-label="New" ng-cloak ng-cloak style="margin-left: 1em;">
    ...
    <md-content>
      ...
      <md-tabs ng-show="!template.loader" md-dynamic-height md-border-bottom class="bg-white" ng-cloak>
        <md-tab label="<?php echo lang2('leads'); ?>">
                  ...
                  <ul class="all-milestone-todos">
                    <li ng-show="template.status == '1'" class="milestone-todos-list-item col-md-12 done" style="color: unset;">
                      <span class="pull-left col-md-6">
                        <strong ng-bind="template.name != null ? template.name : template.subject"></strong><br>
                      </span>
                      <div class="col-md-6">
                        <div class="col-md-8">
                          <span class="date-start-task">
                            <small class="text-muted text-uppercase"><?php echo lang2('subject'); ?></small><br>
                            <strong ng-bind="template.subject"></strong>
                          </span>
                        </div>
                        <div class="col-md-4">
                          <span class="date-start-task">
                            <small class="text-muted text-uppercase"><?php echo lang2('status'); ?></small><br>
                            <strong class="badge green"><?php echo lang2('active'); ?></strong>
                          </span>
                        </div>
                      </div>
                    </li>
                    <li ng-show="template.status != '1'" class="milestone-todos-list-item col-md-12">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                          <span class="date-start-task">
                            <small class="text-muted text-uppercase"><?php echo lang2('status'); ?></small><br>
                            <strong class="badge red"><?php echo lang2('inactive'); ?></strong>
                          </span>
                        </div>
                      </div>
                    </li>
        ...
        <md-tab label="<?php echo lang2('invoices'); ?>" class="bg-white">
          <md-content class="md-padding bg-white">
            <ul class="custom-ciuis-list-body" style="padding: 0px;">
        ...
        <md-tab label="<?php echo lang2('customers'); ?>">
          <md-content class="md-padding bg-white">
            <ul class="custom-ciuis-list-body" style="padding: 0px;">
        ...
        <md-tab label="<?php echo lang2('staff'); ?>">
          <md-content class="md-padding bg-white">
            <ul class="custom-ciuis-list-body" style="padding: 0px;">
        ...
        <md-tab label="<?php echo lang2('depositstitle'); ?>" class="bg-white">
          <md-content class="md-padding bg-white">
            <ul class="custom-ciuis-list-body" style="padding: 0px;">
        ...
        <md-tab label="<?php echo lang2('orders'); ?>">
          <md-content class="md-padding bg-white">
            <ul class="custom-ciuis-list-body" style="padding: 0px;">
        ...
        <md-tab label="<?php echo lang2('quotes'); ?>">
          <md-content class="md-padding bg-white">
            <ul class="custom-ciuis-list-body" style="padding: 0px;">
        ...
        <md-tab label="<?php echo lang2('purchases'); ?>" class="bg-white">
          <md-content class="md-padding bg-white">
            <ul class="custom-ciuis-list-body" style="padding: 0px;">
        ...
        <md-tab label="<?php echo lang2('reports'); ?>" class="bg-white">
          <md-content class="md-padding bg-white">
            <ul class="custom-ciuis-list-body" style="padding: 0px;">
              <li ng-repeat="template in templates | filter: { relation: 'reports' }  " class="milestone-todos-list ciuis-custom-list-item ciuis-special-list-item paginationclass" style="min-width: 100% !important;">
                <a href="<?php echo base_url('emails/template/') ?>{{template.id}}">
                  <ul class="all-milestone-todos">
                    <li ng-show="template.status == '1'" class="milestone-todos-list-item col-md-12 done" style="color: unset;">
                      <span class="pull-left col-md-6">
...
<script type="text/ng-template" id="emailDialog.html">
  <md-dialog aria-label="Expense Detail">
      <md-toolbar class="toolbar-white">
        <div class="md-toolbar-tools">
          <h2><strong class="text-success"><?php echo lang2('email') ?></strong></h2>
          <span flex></span>
      ...
      <md-dialog-content style="max-width:800px;max-height:810px; ">
        <md-content class="bg-white">
          <md-list flex>
            ...
            <md-list-item>
              <p><strong><?php echo lang2('from'); ?></strong>: <span ng-bind="email.to"></span></p>
            </md-list-item>
            <md-list-item>
              <p><strong><?php echo lang2('to'); ?></strong>: <a ng-href="mailto:email.email"><span ng-bind="email.email"></span></a></p><br>
            </md-list-item>
            <md-list-item ng-if="email.attachment">
              <p><strong><?php echo lang2('attachment'); ?></strong>:
