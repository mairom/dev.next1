   ...
   <body ng-controller="Area_Controller">
   	...
   	<md-toolbar class="toolbar-ciuis-top"> 
   		<div class="md-toolbar-tools">
   			...
   			<md-button ng-click="OpenMenu()" class="md-icon-button hidden-lg hidden-md" aria-label="Menu" ng-cloak>
   				<md-tooltip md-direction="left"><?php echo lang2('menu') ?></md-tooltip>
   			...
   			<md-button ng-click="Appointment()" class="md-icon-button" aria-label="Appointment" ng-cloak>
   				<md-tooltip md-direction="left"><?php echo lang2('new_appointment') ?></md-tooltip>
   			...
   			<md-button ng-click="Notifications()" class="md-icon-button" aria-label="Notifications" ng-cloak>
   				<md-tooltip md-direction="left"><?php echo lang2('notifications') ?></md-tooltip>
   			...
   			<div ng-click="Profile()" md-truncate class="user-informations hidden-xs" ng-cloak>
   				...
   				<span class="user-email-in"><?php echo session()->get('email'); ?></span>
   			</div>
   		</div>
   	</md-toolbar>
   	...
   	<md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="Profile"  ng-cloak style="width: 450px;">
         <md-toolbar class="toolbar-white">
            <div class="md-toolbar-tools">
               <md-button ng-click="close()" class="md-icon-button" aria-label="Close"><i class="ion-android-arrow-forward"></i></md-button>
               <md-truncate><?php echo lang2('profile')?></md-truncate>
            </div>
         </md-toolbar>
   		<md-content class="text-center">
   			...
   			<md-content class="md-mt-30">
   				<md-button ng-href="<?php echo base_url('area/login/logout');?>" class="md-raised"><?php echo lang2('logout')?></md-button>
   			</md-content>
   		</md-content>
   	</md-sidenav>
   	<!-- Appointment -->
   	<md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="Appointment"  ng-cloak style="width: 450px;">
   		<md-toolbar class="toolbar-white" style="background:#262626">
   			<div class="md-toolbar-tools">
   				...
   				<md-truncate><?php echo lang2('new_appointment')?></md-truncate>
   			</div>
   		</md-toolbar>
   		<md-subheader ng-if="!AppointmentStaff" class="md-no-sticky"><?php echo lang2('staff_for_appointment')?></md-subheader>
   		...
   		<md-content ng-hide="available_staff.length" class="md-padding text-center">
   			...
   			<span><?php echo lang2('no_available_staff') ?></span>
   		</md-content>
   		<div ng-if="AppointmentStaff">
   			...
   			<md-content ng-hide="Available_Times != false" class="md-padding text-center">
   				...
   				<span><?php echo lang2('day_closed_to_appointments') ?></span>
   			</md-content>
   			<md-content layout-padding="">
   				<md-content layout-padding ng-show="available_staff.length">
   					<div class="text-center">
   						<h4><strong><?php echo lang2('appointment_date')?></strong></h4><br>
   						<strong>{{day.format('dddd, MMMM Do YYYY')}} <strong class="text-warning">{{AppointmentTime}}</strong></strong>
   					</div>
   				</md-content>
   				<section layout="row" layout-sm="column" layout-align="center center" layout-wrap>
   					<md-button ng-click="ResetAppointment()"> <i class="ion-ios-refresh"></i> <?php echo lang2('reset')?></md-button>
   					<md-button ng-click="ConfirmAppointment(day.format('YYYY-MM-DD'))"> <i class="ion-android-checkmark-circle"></i> <?php echo lang2('confirm')?></md-button>
   				</section>
   			</md-content>
   		</div>
   	</md-sidenav>
