...
<div class="ciuis-body-content" ng-controller="Invoice_Controller">
		...
		<md-toolbar class="toolbar-white">
			<div class="md-toolbar-tools">
				...
				<md-button ng-href="<?php echo base_url('share/pdf/{{invoice.token}}') ?>" class="md-icon-button" aria-label="PDF" ng-cloak>
					<md-tooltip md-direction="bottom"><?php echo lang2('download') ?></md-tooltip>
	...
	<div class="main-content container-fluid col-md-3 md-pl-0" ng-cloak>
		<md-toolbar class="toolbar-white">
			<div class="md-toolbar-tools">
				<h2 flex md-truncate class="pull-left" ng-show="invoice.balance != 0 && invoice.status_id != 4"><strong><span><?php echo lang2('balance') ?></span> : <span ng-bind-html="invoice.balance | currencyFormat:cur_code:null:true:cur_lct"></span></strong></h2>
						...
						<?php if (($payment['active'] == '1') && ($invoice['default_payment_method'] == 'paypal')) { ?>
							<md-menu-item>
								<md-button ng-click="PayViaPaypal(invoice.token)"> 
									<div layout="row" flex>
										<p flex><?php echo lang2('pay_via_paypal') ?></p>
						...
						if (($payment['active'] == '1') && ($invoice['default_payment_method'] == 'authorize')) { ?>
							<md-menu-item>
								<md-button ng-click="PayViaAuthorize(invoice.token)">
									<div layout="row" flex>
										<p flex><?php echo lang2('pay_via_authorize_net') ?></p>
						...
						if (($payment['active'] == '1') && ($invoice['default_payment_method'] == 'payumoney')) { ?>
							<md-menu-item>
								<md-button ng-click="PayViaPayUMoney(invoice.token)">
									<div layout="row" flex>
										<p flex><?php echo lang2('pay_via_payumoney') ?></p>
										<md-icon md-menu-align-target class="ion-card" style="margin: auto 3px auto 0;"></md-icon>
									</div>
								</md-button>
							</md-menu-item>
						...
						if (($payment['active'] == '1') && ($invoice['default_payment_method'] == 'ccavenue')) { ?>
							<md-menu-item>
								<md-button ng-click="PayViaCCAvenue(invoice.token)">
									<div layout="row" flex>
										<p flex><?php echo lang2('pay_via_ccavenue') ?></p>
										<md-icon md-menu-align-target class="ion-card" style="margin: auto 3px auto 0;"></md-icon>
									</div>
								</md-button>
							</md-menu-item>
						...
						if (($payment['active'] == '1') && ($invoice['default_payment_method'] == 'stripe')) { ?>
							<md-menu-item>
								<md-button ng-click="PayViaStripe(invoice.token)">
									<div layout="row" flex>
										<p flex><?php echo lang2('pay_via_stripe') ?></p>
										<md-icon md-menu-align-target class="ion-card" style="margin: auto 3px auto 0;"></md-icon>
									</div>
								</md-button>
							</md-menu-item>
						...
						if (($payment['active'] == '1') && ($invoice['default_payment_method'] == 'razorpay')) { ?>
							<md-menu-item>
								<md-button ng-click="PayViaRazorpay(invoice.token)">
									<div layout="row" flex>
										<p flex><?php echo lang2('pay_via_razorpay') ?></p>
										<md-icon md-menu-align-target class="ion-card" style="margin: auto 3px auto 0;"></md-icon>
									</div>
								</md-button>
							</md-menu-item>
				...
				<h2 flex md-truncate class="pull-left text-success" ng-hide="invoice.balance != 0"><strong><?php echo lang2('paidinv') ?></strong></h2>
				<h2 flex md-truncate class="pull-left text-danger text-uppercase" ng-show="invoice.status_id == 4"><strong><?php echo lang2('cancelled') ?></strong></h2>
		...
		<md-content class="bg-white" style="border-bottom:1px solid #e0e0e0;">
			<md-list flex>
				<md-list-item>
					...
					<p><strong><?php echo lang2('duedate') ?>: </strong> <span ng-bind="invoice.duedate_text"></span></p>
				</md-list-item> 
			</md-list>
		</md-content>
		<md-toolbar class="toolbar-white">
	...
	<md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="Discussions"  ng-cloak style="width: 450px;">
		<md-toolbar class="toolbar-white">
			<div class="md-toolbar-tools">
				...
				<md-truncate><?php echo lang2('discussions') ?></md-truncate>
			</div>
		</md-toolbar>
		<md-content class="bg-white">
			<md-list flex>
