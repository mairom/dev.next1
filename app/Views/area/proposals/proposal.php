					...
					<table border="0" cellspacing="0" cellpadding="0">
						<thead>
							<tr>
								...
								<th class="qty"><?php echo lang2('quantity') ?></th>
								<th class="unit"><?php echo lang2('price') ?></th>
								<th class="discount"><?php echo lang2('discount') ?></th>
								<th class="tax"><?php echo $appconfig['tax_label'] ?></th>
								<th class="total"><?php echo lang2('total') ?></th>
							</tr>
						</thead>
						<tbody>
