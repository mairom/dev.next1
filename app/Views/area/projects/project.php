			...
			<md-content class="bg-white">
				<div id="project-details" class="on-schedule projects-top">
					<div layout="row" layout-wrap>
						...
						<div flex-sm="33" flex-xs="50" flex-lg="16" flex-gt-sm="16" class="text-center">
							<h5><?php echo lang2('opentasks') ?></h5>
			...
			<md-tabs md-dynamic-height md-border-bottom>
				<md-tab label="<?php echo lang2('summary') ?>">
					...
					<md-content class="md-padding bg-white">
						<h2><?php echo lang2('description') ?></h2>
						...
						<section class="ciuis-notes show-notes">
							<article ng-repeat="note in notes" class="ciuis-note-detail">
								...
								<div class="ciuis-note-detail-body">
									...
									<p class="attribution"> <?php echo lang2('addedby') ?> <strong><span ng-bind="note.noteby"></span></strong> <?php echo lang2('at') ?> <span ng-bind="note.date"></span> </p>
								</div>
							</article>
						</section>
					</md-content>
									...
									<table id="table2" class="table table-striped table-hover table-fw-widget">
										<thead>
											<tr>
												...
												<th>
													<?php echo lang2('start') ?>
												</th>
												<th>
													<?php echo lang2('end') ?>
												</th>
												<th>
													<?php echo lang2('staff') ?>
												</th>
												<th>
													<?php echo lang2('timed') ?>
												</th>
												<th>
													<?php echo lang2('amount') ?>
												</th>
											</tr>
										</thead>
		...
		<div ng-show="projectFiles" layout-align="center center" class="text-center" id="circular_loader">
			...
			<p style="font-size: 15px;margin-bottom: 5%;">
				<span><?php echo lang2('please_wait') ?> <br>
					<small><strong><?php echo lang2('loading') . ' ' . lang2('project_files') . '...' ?></strong></small>
				</span>
			</p>
		</div>
...
<script type="text/ng-template" id="addfile-template.html">
	<md-dialog aria-label="options dialog">
		<?php
		helper('form');
		echo form_open_multipart('area/projects/add_file/' . $projects['id'] . '', array("class" => "form-horizontal")); ?>
		...
		<md-dialog-actions>
			...
			<md-button type="submit"><?php echo lang2('add') ?>!</md-button>
		</md-dialog-actions>
		<?php echo form_close(); ?>
	</md-dialog>
</script>
<script type="text/ng-template" id="view_image.html">
	<md-dialog aria-label="options dialog">
		...
		<md-dialog-actions>
			<span flex></span>
			<md-button ng-href="<?php echo base_url('area/projects/download_file/') ?>{{file.id}}"><?php echo lang2('download') ?>!</md-button>
			<md-button ng-click="close()"><?php echo lang2('cancel') ?>!</md-button>
		</md-dialog-actions>
		<?php echo form_close(); ?>
	</md-dialog>
