							...
							<div class="hpanel stats">
								<div style="padding-top: 0px;line-height: 0.99;" class="panel-body h-200 xs-p-0">
									<div class="col-md-12 xs-mb-20 nopadding">
										...
										{echo '<div class="col-md-12 text-center"><p><img src="'.base_url('assets/img/morning.png').'" alt=""></p><p><h4>'.lang2('goodmorning').'</h4><span>'.$_SESSION[ 'name' ].'</span></p></div>';} else if ( $time >= "12" && $time < "17" ) 
										{echo '<div class="col-md-12 text-center"><p><img src="'.base_url('assets/img/afternoon.png').'" alt=""></p><p><h4>'.lang2('goodafternoon').'</h4><span>'.session()->get('name').'</span></p></div>';} else if ( $time >= "17" && $time < "19" ) 
										{echo '<div class="col-md-12 text-center"><p><img src="'.base_url('assets/img/evening.png').'" alt=""></p><p><h4>'.lang2('goodevening').'</h4><span>'.session()->get('name').'</span></p></div>';} else if ( $time >= "19" ) 
										{echo '<div class="col-md-12 text-center"><p><img src="'.base_url('assets/img/night.png').'" alt=""></p><p><h4>'.lang2('goodnight').'</h4><span>'.session()->get('name').'</span></p></div>';}?>
							...
							<div class="widget-counter-group widget-counter-group-right">
								<div class="pull-left">
									<div class="pull-left text-left">
										<h4 style="padding: 0px;margin: 0px;"><b><?php echo lang2('salesgraphtitle'); ?></b></h4>
