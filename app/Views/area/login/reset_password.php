...
<head>
	...
	<title>
		<?php echo lang2('resetyourpassword')?>
	</title>
					...
					<md-card flex-xs flex-gt-xs="100" layout="column">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><?php echo lang2('resetyourpassword')?></h3>
								<h6><?php echo lang2('hello')?><span><?php echo $firstName; ?></span>, <?php echo lang2('resetyourpasswordsub')?></h6>
							</div>
							<div class="panel-body">
								<?php $fattr = array('class' => 'form-signin'); 
								echo form_open(site_url().'area/login/reset_password/'.$token, $fattr); ?>
								<div class="form-group">
									<input id="password" required="" type="password" placeholder="<?php echo lang2('password')?>" name="password" autocomplete="off" class="form-control">
									<?php echo form_error('password') ?>
								</div>
								<div class="form-group">
									<input id="passconf" required="" type="password" placeholder="<?php echo lang2('confirmpassword')?>" name="passconf" autocomplete="off" class="form-control">
									<?php echo form_error('passconf') ?>
								</div>
								<?php echo form_error('email') ?>
								<div class="form-group login-submit">
									<button data-dismiss="modal" type="submit" class="login-button btn btn-ciuis btn-xl"><?php echo lang2('resetpassword') ?></button>
								</div>
								<?php echo form_close(); ?>
							</div>
						</div>
