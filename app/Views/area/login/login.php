						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<div class="form-group row login-tools">
									...
									<div class="col-xs-6 login-forgot-password"><a href="<?php echo base_url('area/login/forgot')?>"><?php echo lang2('loginforget')?></a>
									</div>
								</div>
								<div class="form-group login-submit">
									<button data-dismiss="modal" type="submit" class="login-button btn btn-ciuis btn-xl"><?php echo lang2('loginbutton')?></button>
								</div>
