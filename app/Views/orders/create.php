  ...
  <div class="main-content container-fluid col-xs-12 col-md-12 col-lg-9">
    ...
    <md-toolbar class="toolbar-white">
      ...
      <div class="md-toolbar-tools">
        ...
        <h2 flex md-truncate><?php echo lang2('new') . ' ' . lang2('order') ?></h2>

        <md-switch ng-model="order_type" aria-label="Type" ng-cloak><strong class="text-muted"><?php echo lang2('for_lead') ?></strong></md-switch>
    ...
    <md-content class="bg-white" layout-padding ng-cloak>
      ...
      <div layout-gt-xs="row">
        ...
        <md-input-container ng-show="order_type" class="md-block" flex-gt-xs>
          ...
          <md-select required placeholder="<?php echo lang2('choiselead'); ?>" ng-model="lead" name="lead" style="min-width: 200px;">
      ...
      <div layout-gt-xs="row">
        ...
        <md-input-container class="md-block" flex-gt-xs>
          ...
          <md-select required placeholder="<?php echo lang2('assigned'); ?>" ng-model="assigned" name="assigned" style="min-width: 200px;">
        ...
        <md-input-container class="md-block" flex-gt-xs>
          ...
          <md-select ng-init="statuses = [{id: 1,name: '<?php echo lang2('draft'); ?>'}, {id: 2,name: '<?php echo lang2('sent'); ?>'}, {id: 3,name: '<?php echo lang2('open'); ?>'}, {id: 4,name: '<?php echo lang2('revised'); ?>'}, {id:5,name: '<?php echo lang2('declined'); ?>'}, {id: 6,name: '<?php echo lang2('accepted'); ?>'}];" required placeholder="<?php echo lang2('status'); ?>" ng-model="status" name="status" style="min-width: 200px;">
      ...
      <md-checkbox class="pull-right" ng-model="comment" aria-label="Comment"> <strong class="text-muted text-uppercase"><?php echo lang2('allowcomments'); ?></strong> </md-checkbox>
