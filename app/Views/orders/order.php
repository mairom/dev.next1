          ...
          <md-menu ng-if="!order.invoice_id" md-position-mode="target-right target" ng-cloak>
            ...
            <md-menu-content width="4" ng-cloak>
              <md-contet class="text-center" layout-padding> <img height="80%" src="https://cdn4.iconfinder.com/data/icons/business-399/512/invoice-128.png" alt="">
                <p style="max-width: 250px"> <strong ng-show="order.relation_type == true" ><?php echo lang2('leadproposalconvertalert') ?></strong> <strong ng-show="order.relation_type != true" ><?php echo lang2('convert_order_to_invoice'); ?></strong> </p>
            ...
            <div class="proposal">
              <main>
                <div id="details" class="clearfix">
                  ...
                  <div id="client">
                    <div class="to"><span><?php echo lang2('order').' '.lang2('to'); ?>:</span></div>
                    <h2 class="name">
                  ...
                  <div id="invoice">
                    ...
                    <div class="date"><?php echo lang2('dateofissuance')?>: <span ng-bind="order.date"></span></div>
                    <div class="date text-bold"><?php echo lang2('opentill')?>: <span ng-bind="order.opentill"></span></div>
            ...
            <section class="ciuis-notes show-notes">
              <article ng-repeat="comment in order.comments" class="ciuis-note-detail">
                ...
                <div class="ciuis-note-detail-body">
                  ...
                  <p class="attribution"><strong><?php echo lang2('customer_comment')?></strong> <?php echo lang2('at')?> <span ng-bind="comment.created"></span></p>
                </div>
              </article>
            </section>
          </md-content>
...
<script type="text/ng-template" id="generate-order.html">
  <md-dialog aria-label="options dialog">
	...
	<md-dialog-actions>
	  <span flex></span>
	  <md-button class="text-success" ng-if="PDFCreating == false" href="<?php echo base_url('orders/download_pdf/'.$orders['id'].'') ?>"><?php echo lang2('download') ?></md-button>
    <md-button class="text-success" ng-hide="PDFCreating == false" ng-click="CreatePDF()"><?php echo lang2('create') ?>!</md-button>
    <md-button ng-click="CloseModal()"><?php echo lang2('cancel') ?></md-button>
	</md-dialog-actions>
  </md-dialog>
</script> 
<script>
  ...
  lang.delete_order = "<?php echo lang2('delete_meesage').' '.lang2('order')?>";
  lang.convert_title = "<?php echo lang2('information')?>";
  lang.convert_text = "<?php echo lang2('convertmsg').' '.lang2('order').' '.lang2('to').' '.lang2('invoice')?>";
