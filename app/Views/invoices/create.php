  ...
  <div class="main-content container-fluid col-xs-12 col-md-12 col-lg-9">
    ...
    <md-toolbar class="toolbar-white" ng-cloak>
      ...
      <div class="md-toolbar-tools">
        ...
        <h2 flex md-truncate><?php echo lang2('newinvoice') ?></h2>

        <md-switch ng-model="invoice_status" aria-label="Status"><strong class="text-muted"><?php echo lang2('paid') ?></strong></md-switch>
        
        <md-switch ng-model="invoice_recurring" aria-label="Recurring"> <strong class="text-muted"><?php echo lang2('recurring') ?></strong> </md-switch>
        ...
        <md-button type="submit" ng-click="saveAll()" class="md-icon-button" aria-label="Save">
          ...
          <md-tooltip ng-hide="savingInvoice == true" md-direction="bottom"><?php echo lang2('save') ?></md-tooltip>
    ...
    <md-content ng-show="!invoiceLoader" class="bg-white" layout-padding ng-cloak>
      ...
      <div layout-gt-xs="row">
        ...
        <md-input-container class="md-block" flex-gt-sm>
          ...
          <label><?php echo lang2('invoicenumber') ?></label>
        ...
        <md-input-container class="md-block" flex-gt-sm>
          ...
          <input type="date" name="created" ng-model="created" md-open-on-focus></input>
        </md-input-container>

        <md-input-container class="md-block" flex-gt-sm>
          <label><?php echo lang2('duedate') ?></label>
          <input type="date" require md-min-date="duedate" name="duedate" ng-model="duedate" md-open-on-focus></input>
        </md-input-container>
      ...
      <div layout-gt-xs="row">
        ...
        <md-input-container ng-show="invoice_status" class="md-block" flex-gt-xs>
          <label><?php echo lang2('paidcashornank'); ?></label>
          <md-select placeholder="<?php echo lang2('choiseaccount'); ?>" ng-model="account" name="account" style="min-width: 200px;">
...
-->
        ...
        ?>
          <md-input-container class="md-block">
            <label><?php echo lang2('payment_method'); ?></label>
            <md-select placeholder="<?php echo lang2('default_payment_method'); ?>" ng-model="default_payment_method" name="default_payment_method" style="min-width: 200px;">
              <?php
        ...
        <md-input-container class="md-block" style="margin-bottom: 1em !important;">
          <label>Forma de pagamento</label>
          <md-select placeholder="Forma de pagamento" ng-model="invoice.id_forma_pagment" name="default_payment_method" style="min-width: 200px;">
            <md-option ng-value="formaDpag.id_forma" ng-repeat="formaDpag in formas_pagamento">{{formaDpag.nm_forma}}</md-option>
          </md-select>
        </md-input-container>

        <md-input-container ng-show="invoice_status">
          <label><?php echo lang2('datepaid') ?></label>
      ...
      <div ng-show="invoice_recurring" layout-gt-xs="row">
        <md-input-container class="md-block" flex-gt-xs  style="max-width: 400px;">
        ...
        <md-input-container flex-gt-xs  style="max-width: 400px;">
          <label><?php echo lang2('ends_on') ?></label>
          <input  type = "date" name="EndRecurring" ng-model="EndRecurring" style="width: 100%;" md-open-on-focus></input>
        </md-input-container>
      </div>
    ...
    <md-content ng-show="!invoiceLoader" class="bg-white" layout-padding ng-cloak>
      ...
      <md-list-item ng-repeat="item in invoice.items">
        ...
        <div layout-gt-sm="row">
          ...
          <md-autocomplete class="md-autocomplete" md-autofocus md-items="product in GetProduct(item.name)" md-search-text="item.name" md-item-text="product.name" md-selected-item="selectedProduct" md-no-cache="true" md-min-length="0" md-floating-label="<?php echo lang2('productservice'); ?>">
            <md-item-template>
          ...
          <md-input-container class="md-block">
            ...
            <textarea class="min_input_width" ng-model="item.description" placeholder="<?php echo lang2('description'); ?>"></textarea>
            ...
            <input class="min_input_width productId" type="hidden" ng-model="item.product_id">
          ...
          <md-input-container class="md-block">
            ...
            <input class="min_input_width money inptValue" ng-model="item.price">
          ...
          <md-input-container class="md-block">
            ...
            <input class="min_input_width money" id="iptTotal" ng-value="formatReal((item.quantity * (moneyEua(item.price) + (( item.tax ) / 100 * item.quantity * moneyEua(item.price) ) - ( moneyEua(item.discount) / 100 * item.quantity * moneyEua(item.price)))).toFixed(2))">
          </md-input-container>
      ...
      <md-content class="bg-white" layout-padding ng-cloak>
        ...
        <div class="col-md-6 md-pr-0" style="font-weight: 900; font-size: 16px; color: #c7c7c7;">
          ...
          <div class="col-md-7">
            ...
            <div class="text-right text-uppercase text-muted"><?php echo lang2('subtotal') ?>:</div>

            <div ng-show="linediscount() > 0" class="text-right text-uppercase text-muted"><?php echo lang2('total_discount') ?>:</div>

            <!-- <div class="text-right text-uppercase text-muted"><?php echo lang2('total') . ' ' . $appconfig['tax_label'] ?>:</div> -->

            <div class="text-right text-uppercase text-black"><?php echo lang2('grandtotal') ?>:</div>
  ...
  <div class="main-content container-fluid lg-pl-0 col-xs-12 col-md-12 col-lg-3" ng-cloak>
    ...
    <md-toolbar class="toolbar-white">
      ...
      <div class="md-toolbar-tools">
        ...
        <h2 flex md-truncate><?php echo lang2('billing_and_shipping_details') ?></h2>

      </div>

    </md-toolbar>

    <md-subheader class="md-primary bg-white text-uppercase text-bold"><?php echo lang2('billing_address') ?></md-subheader>
    ...
    <md-content layout-padding class="bg-white" ng-cloak>
      ...
      <md-content ng-if='EditBilling == true' layout-padding class="bg-white" ng-cloak>
        ...
        <md-input-container class="md-block">
          ...
          <md-select placeholder="<?php echo lang2('country'); ?>" ng-model="invoice.billing_country_id" ng-change="getBillingStates(invoice.billing_country_id)" name="billing_country" style="min-width: 200px;">
        ...
        <md-input-container class="md-block">
          ...
          <md-select placeholder="<?php echo lang2('state'); ?>" ng-model="invoice.billing_state_id" name="billing_state_id" style="min-width: 200px;">
      ...
      <md-switch ng-model="NeedShippingAddress" aria-label="Status"><strong class="text-muted"><?php echo lang2('need_shipping_address') ?></strong></md-switch>
      ...
      <md-button ng-show='EditBilling == false' ng-click="EditBilling = true" ng-init="EditBilling=false" class="md-icon-button pull-right" aria-label="Edit">
        ...
        <md-tooltip md-direction="left"><?php echo lang2('edit') ?></md-tooltip>
      ...
      <md-button ng-show='EditBilling == true' ng-click="EditBilling = false" class="md-icon-button pull-right" aria-label="Hide Billing Form">
        ...
        <md-tooltip md-direction="left"><?php echo lang2('hide') ?></md-tooltip>
      ...
      <md-button ng-click='CopyBillingFromCustomer()' class="md-icon-button pull-right" aria-label="Billing Copy">
        ...
        <md-tooltip md-direction="left"><?php echo lang2('copy_from_customer') ?></md-tooltip>
    ...
    <md-subheader ng-show='NeedShippingAddress == true' class="md-primary bg-white text-uppercase text-bold"><?php echo lang2('shipping_address') ?></md-subheader>
    ...
    <md-content ng-show='NeedShippingAddress == true' layout-padding class="bg-white" ng-cloak>
      ...
      <md-content ng-show='EditShipping == true' layout-padding class="bg-white" ng-cloak>
        ...
        <md-input-container class="md-block">
          ...
          <md-select placeholder="<?php echo lang2('country'); ?>" ng-model="invoice.shipping_country_id" ng-change="getShippingStates(invoice.shipping_country_id)" name="shipping_country" style="min-width: 200px;">
        ...
        <md-input-container class="md-block">
          ...
          <md-select placeholder="<?php echo lang2('state'); ?>" ng-model="invoice.shipping_state_id" name="shipping_state_id" style="min-width: 200px;">
...
<script src="<?php echo base_url('assets/js/invoices.js?v=1.2.7'); ?>"></script>
<script>
  function initGraph(){

  }
  $(document).ready(function() {
    $(".md-autocomplete").change(function() {
      setTimeout(a => {
        ...
        $(".money").maskMoney({
          ...
          decimal: ',',
          affixesStay: false
        }).trigger('mask.maskMoney').change();
      }, 1000)

    });
    $("md-virtual-repeat-container").click(function() {
      setTimeout(a => {
        $(".money").val($(".money").val().replace('.', ','));
        $(".money").maskMoney({
          prefix: '',
