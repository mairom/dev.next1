		...
		<div class="main-content container-fluid col-xs-12 col-md-12 col-lg-9">
			...
			<md-toolbar ng-show="!invoiceLoader" class="toolbar-white">
				...
				<div class="md-toolbar-tools">
					...
					<h2 flex md-truncate class="text-bold"><?php echo lang2('invoices'); ?><br><small flex md-truncate><?php echo lang2('organizeyourinvoices'); ?></small></h2>

					<div class="ciuis-external-search-in-table">

						<input ng-model="search.customer" class="search-table-external" id="search" name="search" type="text" placeholder="<?php echo lang2('search_by') . ' ' . lang2('customer') ?>">
								...
								<li class="ciuis-custom-list-item-item col-md-12">
									...
									<div class="col-md-9">
										...
										<div class="col-md-3">
											...
											<span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang2('billeddate'); ?></small><br><strong><span class="badge" ng-bind="invoice.created"></span></strong></span>

										</div>

										<div class="col-md-3">

											<span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang2('invoiceduedate'); ?></small><br><strong><span class="badge" ng-bind="invoice.duedate"></span></strong></span>

										</div>

										<div class="col-md-3">

											<span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang2('status'); ?></small><br><strong class="text-uppercase text-{{invoice.color}}" ng-bind="invoice.status"></strong></span>

										</div>

										<div class="col-md-3 text-right">

											<span class="date-start-task"><small class="text-muted text-uppercase"><?php echo lang2('amount'); ?></small><br><strong ng-bind-html="invoice.total | currencyFormat:cur_code:null:true:cur_lct"></strong></span>
					...
					function ReportOverviewConstructor(options) {
...

						{
							...
							return [
								...
								'<div class="sendTime box-foot-left"><?php echo lang2('invoiceamount'); ?><br><span class="box-foot-stats"><strong><?php echo currency; ?> <?php switch ($settings['unitseparator']) {
																																												case ',':
																																													echo number_format($fam, 2, ',', '.');
																																													break;
																																												case '.':
																																													echo number_format($fam, 2, '.', ',');
																																													break;
																																											} ?></strong></span></div>'.replace(/{{date}}/, options.data.date),
								...
								'<div class="box-foot-left"><?php echo lang2('invoiceamount'); ?><br><span class="box-foot-stats"><strong><?php echo currency; ?> <?php switch ($settings['unitseparator']) {
																																									case ',':
																																										echo number_format($ofv, 2, ',', '.');
																																										break;
																																									case '.':
																																										echo number_format($ofv, 2, '.', ',');
																																										break;
								...
								'<div class="box-foot-left"><?php echo lang2('invoiceamount'); ?><br><span class="box-foot-stats"><strong><?php echo currency; ?> <?php switch ($settings['unitseparator']) {
																																									case ',':
																																										echo number_format($oft, 2, ',', '.');
																																										break;
																																									case '.':
																																										echo number_format($oft, 2, '.', ',');
																																										break;
																																								} ?></strong></span></div>'.replace(/{{OdenmeyenInvoicesAmount}}/, options.data.OdenmeyenInvoicesAmount),
								...
								'<div class="box-foot-left"><?php echo lang2('invoiceamount'); ?><br><span class="box-foot-stats"><strong><?php echo currency; ?> <?php switch ($settings['unitseparator']) {
																																									case ',':
																																										echo number_format($vgf, 2, ',', '.');
																																										break;
																																									case '.':
																																										echo number_format($vgf, 2, '.', ',');
																																										break;
																																								} ?></strong></span></div>'.replace(/{{VadesiDolanInvoices}}/, options.data.VadesiDolanInvoices),
