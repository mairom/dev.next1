			...
			<div class="col-md-3 col-sm-3 col-lg-3 nopadding">
				...
				<md-toolbar class="toolbar-white" style="border-right:1px solid #e0e0e0">
					...
					<div class="md-toolbar-tools">
						...
						<h4 class="text-muted" flex md-truncate ><strong><?php echo lang2('panelsummary')?></strong></h4>					
				...
				<md-content class="bg-white ciuis-summary-two">
					...
					<div class="ciuis-dashboard-box-b1-xs-ca-body">
						...
						<div class="ciuis-dashboard-box-stats ciuis-dashboard-box-stats-main">
							...
							<div class="ciuis-dashboard-box-stats-change">
								...
								<div class="ciuis-dashboard-box-stats-period" ><?php echo lang2('thisweek')?></div>
					...
					<div class="hidden-xs" ng-hide="ONLYADMIN != 'true'" >
						...
						<h4 class="text-center"><?php echo lang2('sales_vs_expenses')?></h4>
			...
			<div class="col-sm-9 xs-p-0">
				...
				<md-toolbar class="toolbar-white">
					...
					<div class="md-toolbar-tools">
						...
						<h4 class="text-muted" flex md-truncate ><strong><?php echo lang2('welcome')?></strong></h4>
						...
						<md-button ng-click="SetOnsiteVisit();get_customers();get_staff();" class="md-icon-button" aria-label="Onsite Visits" ng-hide="ONLYADMIN != 'true'" ng-cloak>
							...
							<md-tooltip md-direction="bottom"><?php echo lang2('set_onsite_visit') ?></md-tooltip>
								...
								<div class="hpanel stats">
									...
									<div style="padding-top: 0px;line-height: 0.99;margin-right: 10px;" class="panel-body h-200 xs-p-0">
										...
										<div class="col-md-12 xs-mb-20 md-pl-0" style="margin-top: -14px;">
											...
											<small><strong><?php echo lang2('todayssales')?></strong></small>
										...
										<div class="col-md-12 nopadding md-pt-10 xs-pt-20" style="border-top: 1px solid #e0e0e0;">
											...
											<div class="stats-title"><h4 style="font-weight: 500;color: #c7cbd5;"><?php echo lang2('netcashflow')?></h4></div>
											...
											<div style="height: 10px" class="progress">
												...
												<div style="font-size: 7px;line-height: 10px;width:{{stats.inp}}%" class="progress-bar progress-bar-success progress-bar-striped" ng-bind="stats.inp+'%'"> {{lang.incomings}}<span class="sr-only"><?php echo lang2('incomings')?></span></div>

												<div style="font-size: 7px;line-height: 10px;width:{{stats.ogp}}%" class="progress-bar progress-bar-danger progress-bar-striped" ng-bind="stats.ogp+'%'"> {{lang.outgoings}}<span class="sr-only"><?php echo lang2('outgoings')?></span></div>
											...
											<div class="row">
												...
												<div class="col-xs-6">
													...
													<small class="stats-label text-uppercase text-bold text-success"><?php echo lang2('incomings') ?></small>
												...
												<div class="col-xs-6">
													...
													<small class="stats-label text-uppercase text-bold text-danger"><?php echo lang2('outgoings')?></small>
									...
									<div class="widget-counter-group widget-counter-group-right">
										...
										<div class="pull-left">
											...
											<div class="pull-left text-left">
												...
												<h4 style="padding: 0px;margin: 0px;"><b><?php echo lang2('weeklygraphtitle')?></b></h4>

												<small><?php echo lang2('weeklygraphdetailtext')?></small>
										...
										<div class="counter counter-big">
											...
											<div class="desc"><?php echo lang2('thisweek')?></div>
								...
								<div class="hpanel stats">
									...
									<div style="padding-top: 0px;line-height: 0.99;margin-right: 10px;" class="panel-body h-200 xs-p-0">
										...
										<div class="col-md-12 xs-mb-20 md-pl-0" style="line-height: 28px;">
											...
											<div class="col-md-12  md-pt-10 xs-pt-20 text-center" style="border-top: 1px solid #e0e0e0;" ><?php echo lang2('haveaniceday')?></div>
...
<script type="text/javascript">
	...
	lang.sales_vs_expenses = '<?php echo lang2('sales_vs_expenses') ?>';

	lang.expense = '<?php echo lang2('expense') ?>';

	lang.sale = '<?php echo lang2('sale') ?>';
