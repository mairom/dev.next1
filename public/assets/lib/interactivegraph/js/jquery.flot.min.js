    ...
    function b(av, ai, J, af) {
        ...
        function S(aG) {
            ...
            if (aM.mode == "time") {
                ...
                aR = function (aV, aW) {
                    if (aW.direction == "x") {
                        var data = dataGraph05[totalGraph05];
                        totalGraph05++;
                        return data;
                    } else {
                        return (aV / 100)
        ...
        function ac() {
            ...
            aEM = 1;
            if (aK.length > 10) {
                aEM = Math.floor(aK.length / 10)
            }


            for (var aE = 0; aE < aK.length; aE = (aE + aEM)) {
                var aB = aK[aE],
                    aG = aB.box,
                    aQ = aB.tickLength,
                    aN, aL, aP, aJ;
                ...
                H.beginPath();
                aFM = 1;
                if (aB.ticks.length > 10) {
                    aFM = Math.floor(aB.ticks.length / 10)
                }

                for (aF = 0; aF < aB.ticks.length; aF = (aFM + aF)) {
        ...
        function k() {
            ...
            for (var aD = 0; aD < aJ.length; ++aD) {
                ...
                var ticksaC = aC.ticks.length;
                var aEM = 1;
                if (ticksaC > 10) {
                    aEM = Math.floor(ticksaC / 10)
                }
                for (var aE = 0; aE < ticksaC; aE = aE + aEM) {
                    var aH = aC.ticks[aE];
