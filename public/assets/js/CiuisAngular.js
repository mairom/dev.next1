var CiuisCRM = angular.module('Ciuis', ['Ciuis.datepicker', 'ngMaterial', 'ngMaterialDatePicker', 'currencyFormat', 'ngSanitize'])
...
function Ciuis_Controller($scope, $http, $mdSidenav, $filter, $interval, $mdDialog, $element, $mdToast, $log) {
	...
	$scope.open_messages = buildToggler('Notifications');
...
function showSwal(title, icon, confirmButtonText,) {
