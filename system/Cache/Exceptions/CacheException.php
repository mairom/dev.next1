...
class CacheException extends RuntimeException implements ExceptionInterface
{
    ...
    {
        return new static(lang2('Cache.unableToWrite', [$path]));
    }
    ...
    {
        return new static(lang2('Cache.invalidHandlers'));
    }
    ...
    {
        return new static(lang2('Cache.noBackup'));
    }
    ...
    {
        return new static(lang2('Cache.handlerNotFound'));
    }
}
