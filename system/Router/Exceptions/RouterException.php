...
class RouterException extends FrameworkException
{
    ...
    {
        return new static(lang2('Router.invalidParameterType'));
    }
    ...
    {
        return new static(lang2('Router.missingDefaultRoute'));
    }
    ...
    {
        return new static(lang2('HTTP.controllerNotFound', [$controller, $method]));
    }
    ...
    {
        return new static(lang2('HTTP.invalidRoute', [$route]));
    }
    ...
    {
        return new static(lang2('Router.invalidDynamicController', [$handler]));
    }
    ...
    {
        return new static(lang2('Router.invalidControllerName', [$handler]));
    }
}
