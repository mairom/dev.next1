...
class ValidationException extends FrameworkException
{
    ...
    {
        return new static(lang2('Validation.ruleNotFound', [$rule]));
    }
    ...
    {
        return new static(lang2('Validation.groupNotFound', [$group]));
    }
    ...
    {
        return new static(lang2('Validation.groupNotArray', [$group]));
    }
    ...
    {
        return new static(lang2('Validation.invalidTemplate', [$template]));
    }
    ...
    {
        return new static(lang2('Validation.noRuleSets'));
    }
}
