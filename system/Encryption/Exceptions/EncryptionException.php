...
class EncryptionException extends RuntimeException implements ExceptionInterface
{
    ...
    {
        return new static(lang2('Encryption.noDriverRequested'));
    }
    ...
    {
        return new static(lang2('Encryption.noHandlerAvailable', [$handler]));
    }
    ...
    {
        return new static(lang2('Encryption.unKnownHandler', [$driver]));
    }
    ...
    {
        return new static(lang2('Encryption.starterKeyNeeded'));
    }
    ...
    {
        return new static(lang2('Encryption.authenticationFailed'));
    }
    ...
    {
        return new static(lang2('Encryption.encryptionFailed'));
    }
}
