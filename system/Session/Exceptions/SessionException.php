...
class SessionException extends FrameworkException
{
    ...
    {
        return new static(lang2('Session.missingDatabaseTable'));
    }

    public static function forInvalidSavePath(?string $path = null)
    {
        return new static(lang2('Session.invalidSavePath', [$path]));
    }

    public static function forWriteProtectedSavePath(?string $path = null)
    {
        return new static(lang2('Session.writeProtectedSavePath', [$path]));
    }

    public static function forEmptySavepath()
    {
        return new static(lang2('Session.emptySavePath'));
    }

    public static function forInvalidSavePathFormat(string $path)
    {
        return new static(lang2('Session.invalidSavePathFormat', [$path]));
    }
    ...
    {
        return new static(lang2('Session.invalidSameSiteSetting', [$samesite]));
    }
}
