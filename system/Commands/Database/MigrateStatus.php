...
class MigrateStatus extends BaseCommand
{
    ...
    public function run(array $params)
    {
        ...
        if ($status === []) {
            // @codeCoverageIgnoreStart
            CLI::error(lang2('Migrations.noneFound'), 'light_gray', 'red');
            CLI::newLine();
        ...
        $headers = [
            CLI::color(lang2('Migrations.namespace'), 'yellow'),
            CLI::color(lang2('Migrations.version'), 'yellow'),
            CLI::color(lang2('Migrations.filename'), 'yellow'),
            CLI::color(lang2('Migrations.group'), 'yellow'),
            CLI::color(str_replace(': ', '', lang2('Migrations.on')), 'yellow'),
            CLI::color(lang2('Migrations.batch'), 'yellow'),
        ];
