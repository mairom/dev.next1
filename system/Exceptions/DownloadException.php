...
class DownloadException extends RuntimeException implements ExceptionInterface
{
    ...
    {
        return new static(lang2('HTTP.cannotSetFilepath', [$path]));
    }
    ...
    {
        return new static(lang2('HTTP.cannotSetBinary'));
    }
    ...
    {
        return new static(lang2('HTTP.notFoundDownloadSource'));
    }
    ...
    {
        return new static(lang2('HTTP.cannotSetCache'));
    }
    ...
    {
        return new static(lang2('HTTP.cannotSetStatusCode', [$code, $reason]));
    }
}
