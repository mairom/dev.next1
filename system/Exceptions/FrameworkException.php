...
class FrameworkException extends RuntimeException implements ExceptionInterface
{
    ...
    {
        return new static(lang2('Core.enabledZlibOutputCompression'));
    }
    ...
    {
        return new static(lang2('Core.invalidFile', [$path]));
    }
    ...
    {
        return new static(lang2('Core.invalidDirectory', [$path]));
    }
    ...
    {
        return new static(lang2('Core.copyError', [$path]));
    }
    ...
    public static function forMissingExtension(string $extension)
    {
        if (str_contains($extension, 'intl')) {
            ...
            $message = lang2('Core.missingExtension', [$extension]);
        }
    ...
    {
        return new static(lang2('Core.noHandlers', [$class]));
    }
    ...
    {
        return new static(lang2('Fabricator.createFailed', [$table, $reason]));
    }
}
