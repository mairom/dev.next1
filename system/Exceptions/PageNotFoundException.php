...
class PageNotFoundException extends OutOfBoundsException implements ExceptionInterface, HTTPExceptionInterface
{
    ...
    {
        return new static($message ?? self::lang2('HTTP.pageNotFound'));
    }
    ...
    {
        return new static(self::lang2('HTTP.emptyController'));
    }
    ...
    {
        return new static(self::lang2('HTTP.controllerNotFound', [$controller, $method]));
    }
    ...
    {
        return new static(self::lang2('HTTP.methodNotFound', [$method]));
    }
    ...
    {
        return new static(self::lang2('HTTP.localeNotSupported', [$locale]));
    }
