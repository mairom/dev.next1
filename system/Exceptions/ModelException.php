...
class ModelException extends FrameworkException
{
    ...
    {
        return new static(lang2('Database.noPrimaryKey', [$modelName]));
    }
    ...
    {
        return new static(lang2('Database.noDateFormat', [$modelName]));
    }
    ...
    {
        return new static(lang2('Database.methodNotAvailable', [$modelName, $methodName]));
    }
}
