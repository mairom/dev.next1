...
class HoneypotException extends ConfigException implements ExceptionInterface
{
    ...
    {
        return new static(lang2('Honeypot.noTemplate'));
    }
    ...
    {
        return new static(lang2('Honeypot.noNameField'));
    }
    ...
    {
        return new static(lang2('Honeypot.noHiddenValue'));
    }
    ...
    {
        return new static(lang2('Honeypot.theClientIsABot'));
    }
}
