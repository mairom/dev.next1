...
class ViewException extends FrameworkException
{
    ...
    {
        return new static(lang2('View.invalidCellMethod', ['class' => $class, 'method' => $method]));
    }
    ...
    {
        return new static(lang2('View.missingCellParameters', ['class' => $class, 'method' => $method]));
    }
    ...
    {
        return new static(lang2('View.invalidCellParameter', [$key]));
    }
    ...
    {
        return new static(lang2('View.noCellClass'));
    }
    ...
    {
        return new static(lang2('View.invalidCellClass', [$class]));
    }
    ...
    {
        return new static(lang2('View.tagSyntaxError', [$output]));
    }
    ...
    {
        return new static(lang2('View.invalidDecoratorClass', [$className]));
    }
}
