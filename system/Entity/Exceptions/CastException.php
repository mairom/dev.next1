...
class CastException extends FrameworkException implements HasExitCodeInterface
{
    ...
    {
        return new static(lang2('Cast.baseCastMissing', [$class]));
    }
    ...
    {
        return match ($error) {
            JSON_ERROR_DEPTH          => new static(lang2('Cast.jsonErrorDepth')),
            JSON_ERROR_STATE_MISMATCH => new static(lang2('Cast.jsonErrorStateMismatch')),
            JSON_ERROR_CTRL_CHAR      => new static(lang2('Cast.jsonErrorCtrlChar')),
            JSON_ERROR_SYNTAX         => new static(lang2('Cast.jsonErrorSyntax')),
            JSON_ERROR_UTF8           => new static(lang2('Cast.jsonErrorUtf8')),
            default                   => new static(lang2('Cast.jsonErrorUnknown')),
        };
    }
    ...
    {
        return new static(lang2('Cast.invalidCastMethod', [$method]));
    }
    ...
    {
        return new static(lang2('Cast.invalidTimestamp'));
    }
}
