...
class SecurityException extends FrameworkException implements HTTPExceptionInterface
{
    ...
    {
        return new static(lang2('Security.disallowedAction'), 403);
    }
    ...
    {
        return new static(lang2('Security.insecureCookie'));
    }
    ...
    {
        return new static(lang2('Security.invalidSameSite', [$samesite]));
    }
}
