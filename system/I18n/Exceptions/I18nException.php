...
class I18nException extends FrameworkException
{
    ...
    {
        return new static(lang2('Time.invalidFormat', [$format]));
    }
    ...
    {
        return new static(lang2('Time.invalidMonth', [$month]));
    }
    ...
    {
        return new static(lang2('Time.invalidDay', [$day]));
    }
    ...
    {
        return new static(lang2('Time.invalidOverDay', [$lastDay, $day]));
    }
    ...
    {
        return new static(lang2('Time.invalidHour', [$hour]));
    }
    ...
    {
        return new static(lang2('Time.invalidMinutes', [$minutes]));
    }
    ...
    {
        return new static(lang2('Time.invalidSeconds', [$seconds]));
    }
}
