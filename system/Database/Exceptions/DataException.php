...
class DataException extends RuntimeException implements ExceptionInterface
{
    ...
    {
        return new static(lang2('Database.invalidEvent', [$method]));
    }
    ...
    {
        return new static(lang2('Database.emptyDataset', [$mode]));
    }
    ...
    {
        return new static(lang2('Database.emptyPrimaryKey', [$mode]));
    }
    ...
    {
        return new static(lang2('Database.invalidArgument', [$argument]));
    }

    public static function forInvalidAllowedFields(string $model)
    {
        return new static(lang2('Database.invalidAllowedFields', [$model]));
    }

    public static function forTableNotFound(string $table)
    {
        return new static(lang2('Database.tableNotFound', [$table]));
    }

    public static function forEmptyInputGiven(string $argument)
    {
        return new static(lang2('Database.forEmptyInputGiven', [$argument]));
    }

    public static function forFindColumnHaveMultipleColumns()
    {
        return new static(lang2('Database.forFindColumnHaveMultipleColumns'));
    }
}
