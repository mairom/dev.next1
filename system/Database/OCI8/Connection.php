...
class Connection extends BaseConnection
{
    ...
    {
        return oci_getNumRows($this->stmtId);
    }
    ...
    protected function _fieldData(string $table): array
    {
        ...
        if (($query = $this->query($sql)) === false) {
            throw new DatabaseException(lang2('Database.failGetFieldData'));
        }
    ...
    protected function _indexData(string $table): array
    {
        ...
        if (($query = $this->query($sql)) === false) {
            throw new DatabaseException(lang2('Database.failGetIndexData'));
        }
        $query = $query->getResultObject();
    ...
    protected function _foreignKeyData(string $table): array
    {
        ...
        if ($query === false) {
            throw new DatabaseException(lang2('Database.failGetForeignKeyData'));
        }
    ...
    {
        if ($procedureName === '') {
            throw new DatabaseException(lang2('Database.invalidArgument', [$procedureName]));
        }
