...
class ImageException extends FrameworkException implements ExceptionInterface
{
    ...
    {
        return new static(lang2('Images.sourceImageRequired'));
    }
    ...
    {
        return new static(lang2('Images.fileNotSupported'));
    }
    ...
    {
        return new static(lang2('Images.rotationAngleRequired'));
    }
    ...
    {
        return new static(lang2('Images.invalidDirection', [$dir]));
    }
    ...
    {
        return new static(lang2('Images.invalidPath'));
    }
    ...
    {
        return new static(lang2('Images.exifNotSupported'));
    }
    ...
    {
        return new static(lang2('Images.unsupportedImageCreate') . ' ' . $extra);
    }
    ...
    {
        return new static(lang2('Images.saveFailed'));
    }
    ...
    {
        return new static(lang2('Images.libPathInvalid', [$path]));
    }
    ...
    {
        return new static(lang2('Images.imageProcessFailed'));
    }
}
