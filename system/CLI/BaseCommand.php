...
abstract class BaseCommand
{
    ...
    {
        CLI::write(lang2('CLI.helpUsage'), 'yellow');
        ...
        if (isset($this->description)) {
            CLI::newLine();
            CLI::write(lang2('CLI.helpDescription'), 'yellow');
            CLI::write($this->setPad($this->description, 0, 0, 2));
        }

        if ($this->arguments !== []) {
            CLI::newLine();
            CLI::write(lang2('CLI.helpArguments'), 'yellow');
        ...
        if ($this->options !== []) {
            CLI::newLine();
            CLI::write(lang2('CLI.helpOptions'), 'yellow');
