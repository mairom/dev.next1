...
class FileException extends RuntimeException implements ExceptionInterface
{
    ...
    {
        return new static(lang2('Files.cannotMove', [$from, $to, $error]));
    }
    ...
    {
        return new static(lang2('Files.expectedDirectory', [$caller]));
    }
    ...
    {
        return new static(lang2('Files.expectedFile', [$caller]));
    }
}
