...
class FormatException extends RuntimeException implements ExceptionInterface
{
    ...
    {
        return new static(lang2('Format.invalidFormatter', [$class]));
    }
    ...
    {
        return new static(lang2('Format.invalidJSON', [$error]));
    }
    ...
    {
        return new static(lang2('Format.invalidMime', [$mime]));
    }
    ...
    {
        return new static(lang2('Format.missingExtension'));
    }
}
