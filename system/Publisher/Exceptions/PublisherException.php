...
class PublisherException extends FrameworkException
{
    ...
    {
        return new static(lang2('Publisher.collision', [filetype($to), $from, $to]));
    }
    ...
    {
        return new static(lang2('Publisher.destinationNotAllowed', [$destination]));
    }
    ...
    {
        return new static(lang2('Publisher.fileNotAllowed', [$file, $directory, $pattern]));
    }
}
